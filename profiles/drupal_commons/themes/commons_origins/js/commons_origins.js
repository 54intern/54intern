...
Drupal.behaviors.commons_origins = function (context) {
  $('fieldset.collapsible:not(.commons_origins-processed) > legend > .fieldset-title').each(function() {
    var fieldset = $(this).parents('fieldset').eq(0);
    fieldset.addClass('commons_origins-processed');
