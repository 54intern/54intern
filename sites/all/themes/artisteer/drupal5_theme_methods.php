 ...
 * @ingroup themeable
 */
function artisteer_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function artisteer_feed_icon($url) {
 ...
 */
function artisteer_comment_wrapper($content, $type = null) {
  static $node_type;
