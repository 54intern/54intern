...
function artisteer_process_html(&$variables) {
...
function artisteer_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function artisteer_button($variables) {
 ...
 */
function artisteer_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function artisteer_menu_local_task($variables) {
 ...
 */
function artisteer_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function artisteer_node_preview($variables) {
  $node = $variables['node'];
